    ...
    <div class="row innerPage">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row userInfo">
                ...
                <section>
                    <header class="header">
                        <h1 class="h1error">  <span class="err404"> </span> 404 </h1>
                        <p class="lead text-center"> Desculpe, mas não encontramos o que você procura!</p>
                        <p class="lead text-center">A página ou conteúdo acessado não foi encotado em nosso site. Sentimos muito por isso! Por favor. Faça uma pesquisa, ou ainda veja abaixo uma lista de nossos produtos mais vendidos!</p>
                    </header>
