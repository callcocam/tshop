              ...
              About us
                    ...
                    <div class="row animated">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                            <img class="img-responsive" src="<?=INCLUDE_PATH;?>/images/site/girl1.jpg" alt="img">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                            <img class="img-responsive" src="<?=INCLUDE_PATH;?>/images/site/girl2.jpg" alt="img">
                            <h3 class="block-title-3">
                                Lorem ipsum dolor
                            </h3>
                            <p>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-sm-6">
                            <img class="img-responsive" src="<?=INCLUDE_PATH;?>/images/site/girl3.jpg" alt="img">
                            <h3 class="block-title-3">
                                Consectetur adipiscing
                            </h3>
                            <p>
